...
func pickWinner() {
	...
	if len(temp) > 0 {
		...
		// Slightly modified traditional proof of stake algorithm from all validators who submitted a block, weight them by the number of staked tokens in traditional proof of stake, validators can participate without submitting a block to be forged
	OUTER:
